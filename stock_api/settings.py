...
SECRET_KEY = 'django-insecure-%g=%uk5x4mtwgfi9@r^w-ucc(3a#6(1%fw5)dd5zseiiuz&xqf'
...
MIDDLEWARE = [
    ...
    "corsheaders.middleware.CorsMiddleware", # Agregado para el funcionamiento de CORS
